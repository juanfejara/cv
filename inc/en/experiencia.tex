...
\begin{entrylist}
  \entry
    ...
    {EPAM}
    {DataScience in a big News company (name reserved by NDA), working in RAG Chatbots of the company using ChatGPT, SageMaker and LangChain. NLP, STT, TTS in personal project.}
  \entry
    {08/23-04/24}
    {Data Engineering, Remote, Senior}
    {Sonder {\sl Protect Company}}
	{Sonder is a company in the Real State industry. I made some \href{http:\\https://github.com/juanfejara/sqlfluff-templ-check}{plugin} for SQLFluff to force the use of DBT ref in SQL. Migration from legacy DBT ETL to a domain focused schemas DBT project, in Snowflake.}
  \entry
    {05/21-05/23}
    {Data Engineering, Remote, Senior}
...
I worked on the monolithic backoffice Django ORM migration to BigQuery using dbt and airflow. Optimization of reports, and ETLs using Python, Bash, or SQL as needed, either by creating Docker containers, which run on Kubernetes, or procedures in Celery.
